...
public class Constants {
    ...
    public static final class AlignConstants {
        ...
        public static final double L4_HEIGHT_REAL = Units.inchesToMeters(72);
        public static final double L3_HEIGHT_REAL = Units.inchesToMeters(48);
        public static final double L2_HEIGHT_REAL = Units.inchesToMeters(32);

        public static final double APRILTAG_DISTANCE_WHEN_ALIGNED = Units.inchesToMeters(17.75);
        public static final double APRILTAG_DISTANCE_WHEN_ALIGNED_SPACING = Units.inchesToMeters(19.75);

        public static final double SPACING_TZ = Units.inchesToMeters(2) + Units.inchesToMeters(35.00 / 2);
    }
