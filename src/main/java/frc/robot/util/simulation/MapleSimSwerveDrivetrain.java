...
public class MapleSimSwerveDrivetrain {
    ...
    public static Pose2d getSimulatedPose() {
        return mapleSimDrive.getSimulatedDriveTrainPose();
    }

    public static ChassisSpeeds getSimChassisSpeeds() {
        return mapleSimDrive.getDriveTrainSimulatedChassisSpeedsFieldRelative();
    }
}
