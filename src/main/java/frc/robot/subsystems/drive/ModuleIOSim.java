...
public class ModuleIOSim implements ModuleIO {
    // Constants.TUNER_CONSTANTS doesn't support separate sim constants, so they are declared locally
    private static final double DRIVE_KS = 0.03;
    private static final double DRIVE_KV_ROT =
            0.91035; // Same units as Constants.TUNER_CONSTANTS: (volt * secs) / rotation
    ...
    public ModuleIOSim(SwerveModuleSimulation moduleSimulation) {
        ...
        this.driveMotor = moduleSimulation
                ...
                .withCurrentLimit(Amps.of(Constants.TUNER_CONSTANTS.FrontLeft.SlipCurrent));
